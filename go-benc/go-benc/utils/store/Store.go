...
var StoreBin = ""
...
func (_Store *StoreFilterer) WatchItemSet(fromBlock *uint64, handler func(int, []types.Log)) (string, error) {
	return _Store.contract.WatchLogs(fromBlock, handler, "ItemSet")
}

func (_Store *StoreFilterer) WatchAllItemSet(fromBlock *uint64, handler func(int, []types.Log)) (string, error) {
	return _Store.contract.WatchLogs(fromBlock, handler, "ItemSet")
}
...
//
// Solidity: event ItemSet(bytes32 key, bytes32 value)
func (_Store *StoreSession) WatchItemSet(fromBlock *uint64, handler func(int, []types.Log)) (string, error) {
	return _Store.Contract.WatchItemSet(fromBlock, handler)
}

func (_Store *StoreSession) WatchAllItemSet(fromBlock *uint64, handler func(int, []types.Log)) (string, error) {
